...
- [ ] counselor1@example.com / password123 로 로그인
...
- [ ] "스케줄 추가" 버튼 클릭
- [ ] 시간 선택 (예: 09:00) → 추가 → 자동으로 09:00~09:30 생성 확인
...
- [ ] 상담사 이름 표시 확인
- [ ] 캘린더에서 예약 가능 날짜 선택
- [ ] 시간대 목록에서 시간 선택 (잔여 예약 수 표시 확인)
- [ ] 신청자 정보 입력
  - [ ] 이름: 테스트 신청자
  - [ ] 이메일: test@example.com
  - [ ] 연락처: 010-1234-5678 (선택)
- [ ] "예약 신청" 클릭
- [ ] 완료 페이지에서 예약 완료 메시지 및 예약 정보 요약 확인
...
- [ ] 상태 필터 조회 테스트 (전체/확정/완료/취소)
- [ ] 스케줄 관리에서 해당 스케줄의 예약 카운트 증가 확인 (1/3명)
- [ ] 예약 옆 "작성" 버튼 클릭 → 상담 내용 입력 → 저장
...
- [ ] 같은 스케줄에 3번 예약 (서로 다른 이름/이메일, 각각 다른 초대 토큰 사용)
- [ ] 3번째 예약까지 성공 확인
- [ ] 4번째 예약 시도 → 에러 메시지 확인 ("해당 시간대 예약이 마감되었습니다")
- [ ] 신청자 페이지에서 해당 시간이 선택 불가 표시 확인
